...
pub fn runtime_event_payload(event: RuntimeEvent) -> serde_json::Value {
    match event {
        ...
        RuntimeEvent::MemoryConfirmationRequired {
            turn_id,
            call_id,
            candidate_count,
        } => serde_json::json!({
        ...
        RuntimeEvent::ApprovalReviewStarted {
            approval_id,
            call_id,
            name,
            risk,
        ...
        RuntimeEvent::ApprovalReviewCompleted {
            approval_id,
            call_id,
            risk_level,
            user_authorization,
        ...
        RuntimeEvent::ApprovalReviewDenied {
            approval_id,
            call_id,
            risk_level,
            user_authorization,
        ...
        RuntimeEvent::ApprovalReviewTimedOut {
            approval_id,
            call_id,
            reason,
            elapsed_ms,
            ...
            "type": "approval_review_timed_out",
            "phase": "thinking",
            "approval_id": approval_id,
            "call_id": call_id,
            "reason": reason,
        ...
        RuntimeEvent::ApprovalReviewAborted {
            approval_id,
            call_id,
            reason,
            elapsed_ms,
        ...
        RuntimeEvent::ApprovalModeChanged {
            preset,
            revision,
            reason,
        } => serde_json::json!({
